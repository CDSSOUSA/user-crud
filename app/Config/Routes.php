...
$routes->group('/user', ['namespace' => 'App\Controllers\User'], static function ($routes) {
    ...
    $routes->get('(:any)/edit', 'UserController::edit/$1');
    $routes->get('(:any)', 'UserController::show/$1');
    $routes->post('', 'UserController::create');
    $routes->put('(:any)', 'UserController::update/$1');
    $routes->delete('(:any)', 'UserController::delete/$1');
});
